...
::
::   Homepages: https://sp.chwz.dpdns.org/https://github.com/WindowsAddict/IDM-Activation-Script
::              https://sp.chwz.dpdns.org/https://massgrave.dev/idm-activation-script
::
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://sp.chwz.dpdns.org/https://github.com/WindowsAddict/IDM-Activation-Script & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==6 exit /b
if %_erl%==5 start https://sp.chwz.dpdns.org/https://github.com/WindowsAddict/IDM-Activation-Script & start https://sp.chwz.dpdns.org/https://massgrave.dev/idm-activation-script & goto MainMenu
if %_erl%==4 start https://sp.chwz.dpdns.org/https://www.internetdownloadmanager.com/download.html & goto MainMenu
...
echo You can download it from  https://sp.chwz.dpdns.org/https://www.internetdownloadmanager.com/download.html
goto done
)
...
set link=https://sp.chwz.dpdns.org/https://www.internetdownloadmanager.com/images/idm_box_min.png
call :download
set link=https://sp.chwz.dpdns.org/https://www.internetdownloadmanager.com/register/IDMlib/images/idman_logos.png
call :download
set link=https://sp.chwz.dpdns.org/https://www.internetdownloadmanager.com/pictures/idm_about.png
call :download
